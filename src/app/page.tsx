    ...
    <main className="bg-white">
      <style dangerouslySetInnerHTML={{
        ...
        @keyframes fanRevealLeft {
          0%   { opacity:0; transform: rotate(0deg) scale(0.8) translateY(30px); }
          100% { opacity:1; transform: rotate(-22deg) scale(0.9) translateY(0); }
        }
      ...
      <section className="relative flex flex-col items-center text-center pt-12 pb-6"
        ...
        {/* ── FAN DE IMAGENS ATUALIZADO ──
            Layout fiel à referência: mesmo centro, apenas rotacionado igual as cartas de mão.
        */}
        <div className="relative flex justify-center items-end" style={{ zIndex: 1, width: '100%', height: '280px', flexShrink: 0, marginTop: '20px' }}>
