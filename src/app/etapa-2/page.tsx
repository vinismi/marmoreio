...
export default function Step2Page() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center gap-8 bg-secondary p-4 md:p-8">
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          {colorTextureOptions.map(option => (
            <button 
              ...
              className={cn("p-8 rounded-lg border-4 text-xl font-bold transition-all duration-300 transform", colorTextureChoice === option.label ? 'bg-accent text-accent-foreground border-accent scale-105 shadow-lg' : 'bg-background hover:scale-105 hover:shadow-md border-transparent')}
        ...
        {isCompleted && (
          <div className="mt-8 flex flex-col items-center gap-4 text-center animate-fade-in-up w-full max-w-md">
            ...
            <Button className="bg-accent text-accent-foreground hover:bg-accent/90 btn-golden-glow" onClick={handleNext}>
