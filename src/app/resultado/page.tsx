...
const WhatsAppIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 32 32" fill="currentColor" {...props}><path d="M16.003 0a16 16 0 0 0-16 16c0 4.14 1.57 7.9 4.16 10.84l-4.16 4.16 4.95-3.3c2.6.96 5.48 1.48 8.44 1.48h.01c8.837 0 16-7.163 16-16s-7.163-16-16-16zm7.98 23.36c-.34.34-.78.53-1.25.53-.41 0-.82-.12-1.19-.36-.37-.24-.86-.53-1.47-1.02-.6-.49-1.2-.99-1.8-1.5-.6-.51-1.13-1.13-1.57-1.83-.44-.7-.8-1.57-1.01-2.58-.21-1.01.02-1.8.46-2.38.44-.58 1.1-1.03 1.7-1.11.6-.08 1.1.16 1.47.6.37.44.53.94.6 1.13.07.19.07.37.02.51-.05.14-.14.28-.28.42-.14.14-.28.28-.42.42-.14.14-.23.23-.28.33-.05.09-.09.19-.05.33.05.14.44.83 1.07 1.47.63.63 1.29 1.02 1.42 1.07.14.05.23.05.33-.05.09-.09.28-.28.42-.42.14-.14.28-.28.42-.42.14-.14.28-.23.47-.23.19 0 .99.46 1.18.69.19.23.34.46.46.74.12.28.16.58.12.83-.04.25-.16.48-.34.66z"/></svg>
);
