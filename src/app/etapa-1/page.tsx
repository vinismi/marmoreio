...
export default function Step1Page() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-8 bg-background p-4 md:p-8">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        {floorImages.map((image) => (
          <button
            ...
            className={cn(
              "group overflow-hidden rounded-lg border-4 border-transparent transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-accent focus:ring-offset-2",
      ...
      {isCompleted && (
        <div className="mt-6 flex flex-col items-center gap-4 text-center animate-fade-in-up">
          ...
          <Button variant="outline" className="btn-golden-glow border-accent text-accent hover:bg-accent hover:text-accent-foreground" onClick={handleNext}>
