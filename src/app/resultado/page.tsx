...
const WhatsAppIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path
            d="M16.1,0A16.1,16.1,0,0,0,0,16.1C0,25,7.2,32.1,16.1,32.1h0A16.1,16.1,0,0,0,32.2,16.1h0C32.2,7.2,25,0,16.1,0ZM24.2,19.6c-.4.8-1.1,1.4-2,1.7s-1.6.4-2.4.2c-1.1-.3-2.1-.7-3.2-1.3S14.5,19,13.2,18c-1.3-.9-2.3-2-3.2-3.2s-1.5-2.5-1.9-4a4.4,4.4,0,0,1,.1-3.2,2.8,2.8,0,0,1,1.5-1.9,2.4,2.4,0,0,1,1.1-.4,2.3,2.3,0,0,1,1.4.3,2,2,0,0,1,.8.8.8.8,0,0,1,.2.4c.1.3,0,.6,0,.9s-.3.5-.5.7a1.6,1.6,0,0,1-.6.4c-.2.1-.4.2-.6.3l-.3.1c-.1,0-.2,0-.3.1s-.1.1-.1.2,0,.2.1.3.1.2.2.3.2.2.4.4.3.4.5.5.4.4.6.6.4.4.6.6,1.4,1.4,2.3,2.1.6.5,1.2.9,1.7,1.2h.1c.3.1.7.2,1.1.2h.2c.4,0,.9-.1,1.2-.3s.7-.5,1-.8.4-.6.5-1,.1-1-.1-1.5c0-.1,0-.2,0-.3s-.1-.2-.1-.3a3.5,3.5,0,0,0-.4-.7,2.5,2.5,0,0,0-.6-.6,3.4,3.4,0,0,0-.7-.5c-.3-.1-.5-.2-.8-.2s-.6,0-.8.1h-.5a7.8,7.8,0,0,0-1,.2c-1.1.3-2.2.7-3.2,1.2s-2.1,1-3,1.6-.7.5-1,.7a1.4,1.4,0,0,1-1.1.1,2.9,2.9,0,0,1-2-1.3,4.3,4.3,0,0,1-.5-2.7,5.5,5.5,0,0,1,1-2.9,9.8,9.8,0,0,1,2.5-2.5A13.2,13.2,0,0,1,16.1,3.8a13.3,13.3,0,0,1,5.2,1,10.6,10.6,0,0,1,4.2,3.3,7.9,7.9,0,0,1,1.9,5.2,8.1,8.1,0,0,1-1,4.3C26.1,18.4,25.3,19.2,24.2,19.6Z"
            fill="currentColor"
        />
    </svg>
);
