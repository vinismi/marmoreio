...
export default function Step1Page() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-8 bg-background p-6 md:p-8">
      <h2 className="font-headline text-3xl font-extrabold md:text-4xl text-center">Qual desses pisos você acha mais bonito? 🪩</h2>
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3 w-full max-w-sm md:max-w-none">
