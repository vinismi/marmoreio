...
export default function Step2Page() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center gap-8 bg-secondary p-6 md:p-8">
      <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/concrete-wall.png')] opacity-5"></div>
      <div className="relative z-10 flex flex-col items-center w-full max-w-md md:max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          {colorTextureOptions.map(option => (
            <button 
              ...
              className={cn("p-8 rounded-xl border-4 text-xl font-bold transition-all duration-300 transform w-full h-24 flex items-center justify-center", colorTextureChoice === option.label ? 'bg-accent text-accent-foreground border-accent scale-105 shadow-lg' : 'bg-background hover:scale-105 hover:shadow-md border-transparent')}
