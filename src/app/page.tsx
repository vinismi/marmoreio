  ...
  return (
    <main className="overflow-x-hidden">
      ...
      <section className="dark relative flex min-h-screen flex-col items-center justify-center bg-black p-5 pb-20 text-center text-foreground md:pb-20">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 p-4 px-5">
            <h1 
              className="font-headline text-4xl font-extrabold uppercase leading-tight tracking-tight text-white sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl animate-fade-in-up max-w-4xl"
            ...
            <p 
              className="mt-4 text-lg md:text-xl font-medium text-white/95 animate-fade-in-up max-w-[85%] pb-2"
            ...
            <div 
              className="flex flex-col gap-6 my-2 text-white/90 text-base md:text-lg animate-fade-in-up"
            ...
            <p 
              className="text-sm md:text-lg text-white/80 animate-fade-in-up mt-4 max-w-[85%] sm:max-w-full"
