    ...
    <main className="overflow-x-hidden">
      ...
      <section className="dark relative flex min-h-screen flex-col items-center justify-center bg-black p-5 pb-20 text-center text-foreground md:pb-5">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 p-4 origin-top scale-[.8] sm:scale-100 transition-transform duration-300">
            <h1 
              className="font-headline text-4xl font-extrabold uppercase tracking-tight text-white md:text-6xl lg:text-7xl animate-fade-in-up max-w-4xl"
              style={{ textShadow: '0 0 15px rgba(0,0,0,0.7)', animationDelay: '0.2s' }}
            >
              TRANSFORME QUALQUER PAREDE OU PISO EM UM <span className="text-gradient-gold animated-text-gradient" style={{textShadow: '0 0 25px hsla(var(--accent), 0.8), 0 2px 2px rgba(0,0,0,0.5)'}}>MÁRMORE DE LUXO. 💎</span>
            </h1>
            
            <div 
              className="flex flex-col gap-2 my-4 text-white/90 text-base md:text-lg animate-fade-in-up"
              style={{ animationDelay: '0.4s', textShadow: '0 1px 3px rgba(0,0,0,0.5)' }}
            >
              <p>A técnica que faz pintores comuns faturarem alto.</p>
              <p>Materiais simples. Resultados de luxo.</p>
              <p>Aprenda de forma rápida e prática.</p>
            </div>

            <div className="z-40 w-full max-w-md mt-4">
